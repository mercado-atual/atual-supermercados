  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-1">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-2">🍺 Adega & Bebidas</h1>
          <p className="text-gray-600">As melhores bebidas para todos os momentos!</p>
        </div>
