...
export default function AcouguePage() {
  const { addToCart, isCatalogMode } = useCart();
  const { showToast } = useToast();
  const products = getProductsByCategory("acougue");
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-1">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-2">🥩 Açougue Premium</h1>
          <p className="text-gray-600">Carnes selecionadas com a melhor qualidade!</p>
        </div>
