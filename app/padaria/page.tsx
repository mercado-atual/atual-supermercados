...
export default function PadariaPage() {
  ...
  const products = getProductsByCategory("padaria");
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-1">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-2">🍞 Padaria & Confeitaria</h1>
          <p className="text-gray-600">Pães frescos e doces feitos com carinho todos os dias!</p>
        </div>
